...
acadoWorkspace.state[82] = acadoVariables.u[lRun1];
...
acadoWorkspace.EH[lRun1 * 49 + 7] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[55];
acadoWorkspace.EH[lRun1 * 49 + 1] = acadoWorkspace.EH[lRun1 * 49 + 7];
acadoWorkspace.EH[lRun1 * 49 + 8] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[56];
acadoWorkspace.EH[lRun1 * 49 + 14] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[57];
acadoWorkspace.EH[lRun1 * 49 + 2] = acadoWorkspace.EH[lRun1 * 49 + 14];
acadoWorkspace.EH[lRun1 * 49 + 15] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[58];
acadoWorkspace.EH[lRun1 * 49 + 9] = acadoWorkspace.EH[lRun1 * 49 + 15];
acadoWorkspace.EH[lRun1 * 49 + 16] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[59];
acadoWorkspace.EH[lRun1 * 49 + 21] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[60];
acadoWorkspace.EH[lRun1 * 49 + 3] = acadoWorkspace.EH[lRun1 * 49 + 21];
acadoWorkspace.EH[lRun1 * 49 + 22] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[61];
acadoWorkspace.EH[lRun1 * 49 + 10] = acadoWorkspace.EH[lRun1 * 49 + 22];
acadoWorkspace.EH[lRun1 * 49 + 23] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[62];
acadoWorkspace.EH[lRun1 * 49 + 17] = acadoWorkspace.EH[lRun1 * 49 + 23];
acadoWorkspace.EH[lRun1 * 49 + 24] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[63];
acadoWorkspace.EH[lRun1 * 49 + 28] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[64];
acadoWorkspace.EH[lRun1 * 49 + 4] = acadoWorkspace.EH[lRun1 * 49 + 28];
acadoWorkspace.EH[lRun1 * 49 + 29] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[65];
acadoWorkspace.EH[lRun1 * 49 + 11] = acadoWorkspace.EH[lRun1 * 49 + 29];
acadoWorkspace.EH[lRun1 * 49 + 30] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[66];
acadoWorkspace.EH[lRun1 * 49 + 18] = acadoWorkspace.EH[lRun1 * 49 + 30];
acadoWorkspace.EH[lRun1 * 49 + 31] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[67];
acadoWorkspace.EH[lRun1 * 49 + 25] = acadoWorkspace.EH[lRun1 * 49 + 31];
acadoWorkspace.EH[lRun1 * 49 + 32] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[68];
acadoWorkspace.EH[lRun1 * 49 + 35] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[69];
acadoWorkspace.EH[lRun1 * 49 + 5] = acadoWorkspace.EH[lRun1 * 49 + 35];
acadoWorkspace.EH[lRun1 * 49 + 36] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[70];
acadoWorkspace.EH[lRun1 * 49 + 12] = acadoWorkspace.EH[lRun1 * 49 + 36];
acadoWorkspace.EH[lRun1 * 49 + 37] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[71];
acadoWorkspace.EH[lRun1 * 49 + 19] = acadoWorkspace.EH[lRun1 * 49 + 37];
acadoWorkspace.EH[lRun1 * 49 + 38] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[72];
acadoWorkspace.EH[lRun1 * 49 + 26] = acadoWorkspace.EH[lRun1 * 49 + 38];
acadoWorkspace.EH[lRun1 * 49 + 39] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[73];
acadoWorkspace.EH[lRun1 * 49 + 33] = acadoWorkspace.EH[lRun1 * 49 + 39];
acadoWorkspace.EH[lRun1 * 49 + 40] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[74];
acadoWorkspace.EH[lRun1 * 49 + 42] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[75];
acadoWorkspace.EH[lRun1 * 49 + 6] = acadoWorkspace.EH[lRun1 * 49 + 42];
acadoWorkspace.EH[lRun1 * 49 + 43] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[76];
acadoWorkspace.EH[lRun1 * 49 + 13] = acadoWorkspace.EH[lRun1 * 49 + 43];
acadoWorkspace.EH[lRun1 * 49 + 44] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[77];
acadoWorkspace.EH[lRun1 * 49 + 20] = acadoWorkspace.EH[lRun1 * 49 + 44];
acadoWorkspace.EH[lRun1 * 49 + 45] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[78];
acadoWorkspace.EH[lRun1 * 49 + 27] = acadoWorkspace.EH[lRun1 * 49 + 45];
acadoWorkspace.EH[lRun1 * 49 + 46] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[79];
acadoWorkspace.EH[lRun1 * 49 + 34] = acadoWorkspace.EH[lRun1 * 49 + 46];
acadoWorkspace.EH[lRun1 * 49 + 47] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[80];
acadoWorkspace.EH[lRun1 * 49 + 41] = acadoWorkspace.EH[lRun1 * 49 + 47];
acadoWorkspace.EH[lRun1 * 49 + 48] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.state[81];
}
return ret;
}
...
acadoVariables.mu[114] = acadoWorkspace.y[20];
acadoVariables.mu[115] = acadoWorkspace.y[21];
acadoVariables.mu[116] = acadoWorkspace.y[22];
acadoVariables.mu[117] = acadoWorkspace.y[23];
acadoVariables.mu[118] = acadoWorkspace.y[24];
acadoVariables.mu[119] = acadoWorkspace.y[25];
...
acadoWorkspace.state[82] = acadoVariables.u[index];
...
if (uEnd != 0)
{
acadoWorkspace.state[82] = uEnd[0];
}
else
{
acadoWorkspace.state[82] = acadoVariables.u[19];
}
